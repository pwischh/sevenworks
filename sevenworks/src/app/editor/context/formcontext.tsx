    ...
    try {
      ...
      try {
        ...
        if (
          ...
          (
            (error as { toString: () => string }).toString().includes('resource-exhausted') ||
            (error as { toString: () => string }).toString().includes('Quota exceeded')
          )
        ) {
    ...
    try {
      ...
      try {
        ...
        if (
          ...
          typeof (firebaseError as { toString: () => string }).toString === "function" &&
          (
            (firebaseError as { toString: () => string }).toString().includes('resource-exhausted') ||
            (firebaseError as { toString: () => string }).toString().includes('Quota exceeded')
          )
        ) {
